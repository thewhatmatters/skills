#!/usr/bin/env python3
"""Readiness check for generate-prd (spec A6).

One concern: confirm we can write the PRD where the user asked. generate-prd
...
def check_target(out):
    ...
    generate-skill preflight idiom — no clobber-protection for a specific
