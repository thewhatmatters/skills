...
## 3. Decision log
- 2026-05-19: scaffolded by generate-skill.
- 2026-05-19: **Markdown input, not JSON.** Unlike deep-research/generate-prd
...
- 2026-05-19: **Standalone skill, not a shared asset.** Decided with the user:
  this does not refactor the inline CSS in deep-research/generate-prd/scan-trends
...
- 2026-05-19: **Web fonts ON by default (conscious A10 waiver).** The output's
  ...
  not a bug.
- 2026-05-19: **Referenced opt-in by deep-research & generate-prd.** Those two
  write a Markdown file (`research-<slug>.md` / `prd-<slug>.md`), so their
  SKILL.md now notes /render-html as a branded-HTML alternative to render that
  ...
  source-badge fidelity) is retained. scan-trends was deliberately excluded — its
...
- 2026-05-20: **Bugfix — nested inline placeholders left NUL bytes.** `inline()`
  ...
  inside link text (e.g. ``[`scan-trends`](dir/)`` — pervasive in README.md
