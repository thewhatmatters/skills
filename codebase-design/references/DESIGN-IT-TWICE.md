...
Uses the vocabulary in [../SKILL.md](../SKILL.md) — **module**,
...
Include both [../SKILL.md](../SKILL.md) vocabulary and `CONTEXT.md`
vocabulary in the brief so each sub-agent names things consistently with
the architecture language and the project's domain language.
