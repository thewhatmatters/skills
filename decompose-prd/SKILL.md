...
Trigger with "convert this PRD to prd.json", "decompose this PRD into Ralph tasks", "taskify this spec", or `/decompose-prd <prd-file>`. Consumes the markdown PRD that `generate-prd` produces.
...
| `--project=PATH` | project root to scan for project-level skills and resolve the Ralph dir (default: cwd) |
