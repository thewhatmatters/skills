...
|------|---------|-------------------|------------------|
| `CRITIC_MISSING` | no critic binary resolves | Fix it for me (install hint) / I'll do it myself / Skip | degrade: isolated subagent critic — isolation kept, vendor diversity lost; disclosed in report |
